...
public class LevelManager_MatchCard : MonoBehaviour
{
    
    private static LevelManager_MatchCard instance;

    public static LevelManager_MatchCard Instance{ get { return instance; } }
